...
@section('page_title') Translators @endsection
...
@section('main_content')
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-heading bg-purple">
                    <h3 class="card-title text-white">All Translators</h3>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-striped text-center">
                        ...
                        @foreach($translators as $single_item)
                            <tr>
                            ...
                            <div id="custom-modal-{{ $single_item->id }}" class="modal-demo text-left">
                                ...
                                <h4 class="custom-modal-title">Update Translator Info</h4>
                                <div class="custom-modal-text">
                                    <form action="{{ route('manage_translator.update', $single_item->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method("PUT")
                                        ...
                                        <div class="text-center">
                                            <input type="submit" class="btn btn-success" value="Update Translator">
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div id="delete-modal-{{ $single_item->id }}" class="modal-demo text-left">
                                ...
                                <h4 class="custom-modal-title">Delete Translator</h4>
                                <div class="custom-modal-text text-center">
                                    <h4 style="font-size: 24px">Are you sure to delete?</h4>
                                    <p>NB: All of books of this Translator will be affected.</p>
                                    <form action="{{ route('manage_translator.destroy', $single_item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <div class="text-center">
                                            <input type="submit" class="btn btn-danger m-r-5" value="DELETE TRANSLATOR">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-heading bg-purple">
                    <h3 class="card-title text-white">Add New Translator</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('manage_translator.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                        ...
                        <div class="text-center">
                            <input type="submit" class="btn btn-success" value="Add Translator">
                        </div>
                    </form>
                </div>
            </div>
