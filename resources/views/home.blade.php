        ...
        <div class="col-lg-4">
            <div class="card-box">
                ...
                <div class="inbox-widget slimscroll-alt" style="min-height: 372px;">
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img src="{{ asset('admin') }}/images/users/avatar-6.jpg" class="rounded-circle" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img src="{{ asset('admin') }}/images/users/avatar-8.jpg" class="rounded-circle" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img src="{{ asset('admin') }}/images/users/avatar-9.jpg" class="rounded-circle" alt=""></div>
            ...
            <div class="card-box">
                ...
                <div class="table-responsive">
                    <table class="table table table-hover m-0">
                        ...
                        <tr>
                            <th>
                                <img src="{{ asset('admin') }}/images/users/avatar-6.jpg" alt="user" class="thumb-sm rounded-circle" />
                            </th>
                            <td>
                        ...
                        <tr>
                            <th>
                                <img src="{{ asset('admin') }}/images/users/avatar-7.jpg" alt="user" class="thumb-sm rounded-circle" />
                            </th>
                            <td>
                        ...
                        <tr>
                            <th>
                                <img src="{{ asset('admin') }}/images/users/avatar-8.jpg" alt="user" class="thumb-sm rounded-circle" />
                            </th>
                            <td>
